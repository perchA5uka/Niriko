...
class SteamOpenIdClientTest {
    ...
    fun buildLoginUrl_containsRequiredParams() {
        ...
        assertTrue(url.contains("openid.return_to=niriko%3A%2F%2Fsteam-auth"))
        assertTrue(url.contains("openid.realm=niriko%3A%2F%2Fsteam-auth"))
    ...
    fun parseCallback_extractsSteamId64() {
        val url = "niriko://steam-auth?openid.ns=...&openid.mode=id_res" +
